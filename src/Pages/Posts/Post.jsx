...
const Post = () => {
  return (
    <article className="Post  px-[3rem] flex  flex-col flex-3">
      ...
      <span className="post-title text-center my-[0.2rem]  md:text-xl font-bold cursor-pointer">
      ...
      <p className="text-sm text-gray-600 my-[0.3rem] ">
        ...
        repudiandae. Aspernatur ipsa tenetur animi sapiente magnam modi mollitia
        doloremque officia architecto hic delectus optio, necessitatibus non
        maiores minus, laboriosam unde ratione quia totam dolorem ab! Cupiditate
        tenetur voluptate atque temporibus unde maxime corporis, voluptatibus
        dolor ipsum nam vitae excepturi veniam eaque nulla esse cumque.
      </p>
      {/* </div> */}
    </article>
    // <div></div>
